...
abstract class Option implements IteratorAggregate
{
     ...
     */
    public function transpose(): \Cline\Monad\Result\Result
    {
        // None => Ok(None)
        if ($this->isEmpty()) {
     ...
     * @return \Cline\Monad\Result\Result<T, E> Ok with value if Some, Err with error if None
     */
    public function okOr($err): \Cline\Monad\Result\Result
    {
        if ($this->isDefined()) {
     ...
     * @return \Cline\Monad\Result\Result<T, E> Ok with value if Some, Err with computed error if None
     */
    public function okOrElse(callable $err): \Cline\Monad\Result\Result
    {
        if ($this->isDefined()) {
            return new Ok($this->get());
        }
