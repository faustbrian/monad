...
use Cline\Monad\Exceptions\ExpectedOptionException;
use Cline\Monad\Exceptions\InvalidLazyOptionCallbackException;
use Deprecated;
use Exception;
...
final class LazyOption extends Option
{
    ...
    public function __construct(
        ...
        throw_unless(is_callable($callback), InvalidLazyOptionCallbackException::create());
    ...
    private function option(): Option
    {
        if (null === $this->option) {
            ...
            if ($option instanceof Option) {
                ...
                throw ExpectedOptionException::fromValue($option);
            }
        }
