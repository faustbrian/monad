...
use Cline\Monad\Exceptions\ExpectedEitherException;
use Cline\Monad\Exceptions\InvalidLazyEitherCallbackException;
...
final class LazyEither extends Either
{
    ...
    public function __construct(
        ...
        throw_unless(is_callable($callback), InvalidLazyEitherCallbackException::create());
    ...
    private function either(): Either
    {
        if (null === $this->either) {
            ...
            if (!$either instanceof Either) {
                throw ExpectedEitherException::fromValue($either);
            }
