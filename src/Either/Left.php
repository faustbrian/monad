...
final class Left extends Either
{
     ...
     *
     * @throws CannotUnwrapRightFromLeftException Always thrown since Left has no Right value
     *
     * @return never This method never returns normally
     */
    public function unwrap(): never
    {
        throw CannotUnwrapRightFromLeftException::create();
    }
     ...
     * @return self<L, R>       This Left instance
     */
    public function filter(callable $predicate, $leftValue): self
    {
        return $this;
    }
