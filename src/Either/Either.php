...
abstract class Either implements IteratorAggregate
{
     ...
     */
    public static function fromNullable($value, $leftValue = null)
    {
     ...
     */
    public static function tryCatch(callable $callable)
    {
        try {
     ...
     */
    public static function cond(bool $condition, $rightValue, $leftValue)
    {
     ...
     */
    public static function sequence(array $eithers)
    {
        $results = [];
     ...
     * @return self<U, array<int, V>> Right with array of values or first Left
     */
    public static function traverse(array $items, callable $f)
    {
        $results = [];
    ...
    public function unzip(): array
    {
        ...
        throw new RuntimeException('Either::unzip expects Right([a,b]).');
    }
     ...
     * ```
     *
     * @return \Cline\Monad\Option\Option<R> Some containing Right value, or None if Left
     */
     ...
     * ```
     *
     * @return \Cline\Monad\Result\Result<R, L> Ok with Right value, or Err with Left value
     */
