...
use ArrayIterator;
use Cline\Monad\Exceptions\CannotUnwrapLeftFromRightException;
use Cline\Monad\Exceptions\FlatMapMustReturnEitherException;
...
final class Right extends Either
{
     ...
     *
     * @throws CannotUnwrapLeftFromRightException Always thrown since Right has no Left value
     *
     * @return never This method never returns normally
     */
    public function unwrapLeft(): never
    {
        throw CannotUnwrapLeftFromRightException::create();
    }
     ...
     */
    public function mapLeft(callable $callable): self
    {
        return $this;
    }
     ...
     *
     * @phpstan-return self<T, U>
     */
    public function bimap(callable $leftFn, callable $rightFn): self
    {
        /** @phpstan-ignore return.type */
     ...
     *
     * @throws FlatMapMustReturnEitherException When callable doesn't return an Either
     *
    ...
    public function flatMap(callable $callable)
    {
        ...
        throw_unless($rs instanceof Either, FlatMapMustReturnEitherException::create());
     ...
     * @return self<L, R>        This Right instance
     */
    public function forLeft(callable $callable): self
    {
        return $this;
    }
     ...
     */
    public function inspect(callable $callable): self
    {
        $callable($this->value);
     ...
     * @return self<L, R>|Left<L, R> This Right if predicate passes, Left otherwise
     */
    public function filter(callable $predicate, $leftValue): self|Left
    {
