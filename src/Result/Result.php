...
abstract class Result
{
     ...
     *
     * @return Option<self<T, E>> Transposed Option containing Result
     */
    public function transpose()
    {
        if ($this->isOk()) {
            ...
            throw new RuntimeException('Result::transpose expects Ok(Option), got '.(is_object($ok) ? $ok::class : gettype($ok)));
        }
